...
const MovieIntro = () => {
  return (
    <section className={styles.MovieIntroWrap}>
      ...
      <div className={styles.PlanIntro}>
        <div className={styles.ProjectPlanTitle}>💡 프로젝트 사용 스킬</div>
        <div className={styles.divider}></div>
        <div className={styles.MovieIntroContent}>
          <div>
            <img
              alt="Notion logo"
              src="https://www.notion.so/cdn-cgi/image/format=auto,width=640,quality=100/front-static/shared/icons/notion-app-icon-3d.png"
              height="65"
              width="65"
            />
            <img
